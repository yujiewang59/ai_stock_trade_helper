...
def base_output_data_saver(sft_data: dict, rlaif_data: dict):
    sft_path = "dataset/base/base_analysis_SFT_data.json"
    rlaif_path = "dataset/base/base_analysis_RLAIF_data.json"
...
def technical_output_data_saver(sft_data: dict, rlaif_data: dict):
    """保存生成的技术面分析数据到本地文件"""
    sft_path = "dataset/tech/technical_analysis_SFT_data.json"
    rlaif_path = "dataset/tech/technical_analysis_RLAIF_data.json"
...
def sentiment_output_data_saver(sft_data: dict, rlaif_data: dict):
    """保存生成的市场情绪分析数据到本地文件"""
    sft_path = "dataset/senti/sentiment_analysis_SFT_data.json"
    rlaif_path = "dataset/senti/sentiment_analysis_RLAIF_data.json"
